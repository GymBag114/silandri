---
title: 挖坟：开始之前
description: 通过本页面开启您的 EVE Online 探索之旅，了解新手任务流程、基础扫描操作以及进入宇宙前的核心准备工作。
---
...
:::tip 阅读顺序
建议先看完本页，再继续阅读 [入门正文](./basics.md)；高危站点和复杂路线统一放在 [进阶实践](./advanced-practice.md)，配装表和查表附录统一放在 [补充内容](./supplemental-content.md)。
:::
...
![0-1-first-exploration-26](/image/post/eve_guide/explore/getting-started/first-exploration-26.webp) 是精确发射，点击一下

![0-1-first-exploration-28](/image/post/eve_guide/explore/getting-started/first-exploration-28.webp) 是分散发射，点击一下，

注意观察他们的不同

![0-1-first-exploration-30](/image/post/eve_guide/explore/getting-started/first-exploration-30.webp) 是收回你在太空中的探针
...
![1.00](/image/post/eve_guide/explore/getting-started/first-exploration-32.webp)

看着这么多红色的球是不是眼晕，有个很简单的办法能让你盯住一个信号扫描

![1.00](/image/post/eve_guide/explore/getting-started/first-exploration-33.webp)
