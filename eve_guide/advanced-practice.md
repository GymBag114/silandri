---
title: 挖坟：进阶实践
description: 深入了解 EVE Online 探索的高阶实践，本页面为您提供幽灵坟、冬眠者储藏站等高价值高风险站点的详尽处理流程与进阶攻略。
---
# 挖坟：进阶实践
...
![7-2-gas-sites-01](/image/post/eve_guide/explore/advanced/gas-sites-01.webp)
低安
...
![7-2-gas-sites-02](/image/post/eve_guide/explore/advanced/gas-sites-02.webp)
...
![7-2-combat-gas-level-1](/image/post/eve_guide/explore/advanced/combat-gas-level-1.webp)

激活轨道后，你在第一层可以看到左右有两个轨道，分别通往第二第三层，第二层出产技能书，第三层出产标准药丸蓝图。直接开推子冲第二层轨道即可。如果觉得抗不住，可以隐身开推子一轮再慢慢爬过去，注意空间实体，手动控制方向折返一下。

#### 第二层

![7-2-combat-gas-level-2](/image/post/eve_guide/explore/advanced/combat-gas-level-2.webp)
...
![7-2-combat-gas-level-3](/image/post/eve_guide/explore/advanced/combat-gas-level-3.webp)

## 受限的冬眠者储藏站 Limited Sleeper Caches

受限的冬眠者储藏站是一个四级数据站点，只限制护卫等级船只进入，收益在 20m 左右，需要 `85+`（拢针）的扫描强度，大部分为红色难度核心，整体难度较为简单。

![7-3-limited-sleeper-cache](/image/post/eve_guide/explore/advanced/limited-sleeper-cache.webp)
...
![7-4-standard-sleeper-cache-logistics-01](/image/post/eve_guide/explore/advanced/standard-sleeper-cache-logistics-01.webp)
...
![7-4-standard-sleeper-cache-logistics-02](/image/post/eve_guide/explore/advanced/standard-sleeper-cache-logistics-02.webp)
后部
...
![7-5-superior-sleeper-cache-solray](/image/post/eve_guide/explore/advanced/superior-sleeper-cache-solray.webp)
...
![7-5-superior-sleeper-cache-sentry-room](/image/post/eve_guide/explore/advanced/superior-sleeper-cache-sentry-room.webp)
...
![7-5-superior-sleeper-cache-mine-room-01](/image/post/eve_guide/explore/advanced/superior-sleeper-cache-mine-room-01.webp)
操作示意图
...
![7-5-superior-sleeper-cache-mine-room-02](/image/post/eve_guide/explore/advanced/superior-sleeper-cache-mine-room-02.webp)

![7-5-superior-sleeper-cache-mine-room-03](/image/post/eve_guide/explore/advanced/superior-sleeper-cache-mine-room-03.webp)
雷区箱子分布图

![7-5-superior-sleeper-cache-mine-room-04](/image/post/eve_guide/explore/advanced/superior-sleeper-cache-mine-room-04.webp)
上俯视图
下侧视图
...
![7-5-superior-sleeper-cache-archive](/image/post/eve_guide/explore/advanced/superior-sleeper-cache-archive.webp)
...
![7-6-one-probing-01](/image/post/eve_guide/explore/advanced/one-probing-01.webp)

![7-6-one-probing-02](/image/post/eve_guide/explore/advanced/one-probing-02.webp)
...
![7-6-interface-layout](/image/post/eve_guide/explore/advanced/interface-layout.webp)
...
![7-6-interface-points-01](/image/post/eve_guide/explore/advanced/interface-points-01.webp)

找到右图这个正方形，点击后就会把这个窗口放在主界面上，然后点击边上的 pin 按钮，将其固定。

![7-6-interface-points-02](/image/post/eve_guide/explore/advanced/interface-points-02.webp)
...
![7-6-fast-loot-setup-01](/image/post/eve_guide/explore/advanced/fast-loot-setup-01.webp)

![7-6-fast-loot-setup-02](/image/post/eve_guide/explore/advanced/fast-loot-setup-02.webp)
...
![7-6-overview](/image/post/eve_guide/explore/advanced/overview.webp)
...
![7-6-overview-normal-cans](/image/post/eve_guide/explore/advanced/overview-normal-cans.webp)

#### 冬眠坟的箱子

![7-6-overview-sleeper-cans](/image/post/eve_guide/explore/advanced/overview-sleeper-cans.webp)

#### 冬眠坟中的空间实体以及信标

![7-6-overview-sleeper-beacons](/image/post/eve_guide/explore/advanced/overview-sleeper-beacons.webp)

#### 冬眠坟中的炮塔

![7-6-overview-sleeper-turrets](/image/post/eve_guide/explore/advanced/overview-sleeper-turrets.webp)

#### 冬眠坟中可以放东西的箱子

![7-6-overview-sleeper-containers](/image/post/eve_guide/explore/advanced/overview-sleeper-containers.webp)
...
![7-6-ultimate-astero](/image/post/eve_guide/explore/advanced/ultimate-astero.webp)
